...
site_config = {
    ...
    'pipe_archive_folder_path': '/home/bj/ptr/pipearchive/',  #WER changed Z to X 20231113 @1:16 UTC
    'temporary_local_pipe_archive_to_hold_files_while_copying' : '/home/bj/ptr/pipetemp',

    # Setup of folders on local and network drives.
    'client_hostname':  'ptr-dev-linux',
    'archive_path':  '/home/bj/ptr/',  # Generic place for this host to stash misc stuff
    'alt_path':  '/home/bj/ptr/',  # Generic place for this host to stash misc stuff
    'save_to_alt_path' : 'no',
    'local_calibration_path': '/home/bj/ptr/', # THIS FOLDER HAS TO BE ON A LOCAL DRIVE, not a network drive due to the necessity of huge memmap files
    ...
    'mount': {
        'SimMount': {
            ...
            'driver': 'alpaca://127.0.0.1:11111/telescope/0',
    ...
    'focuser': {
        'SimFocuser': {
            ...
            'driver': 'alpaca://127.0.0.1:11111/focuser/0',
			'com_port':  'COM9',
    ...
    'filter_wheel': {
        "SimFW": {
            ...
            "driver": 'alpaca://127.0.0.1:11111/filterwheel/0',
            'ip_string': None,
            "dual_wheel": False,
            'settings': {
    ...
    'camera': {
        'SimZWO1600': {
            ...
            'driver': 'alpaca://127.0.0.1:11111/camera/0',


            'detector':  'KAF16803',
            'manufacturer':  'On-Semi',
            'use_file_mode':  False,
            'file_mode_path':  '/home/bj/ptr/autosaves/',   #NB Incorrect site, etc. Not used at SRO.  Please clean up.
