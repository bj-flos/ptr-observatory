# -*- coding: utf-8 -*-
"""
Photon Ranch service endpoints.
...
environment variables is set -- typically from .env, which obs.py loads through
...
try:
    # obs.py never calls load_dotenv itself, so do it here: this module is
